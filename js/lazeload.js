    ...
    LazyLoad.prototype = {
        ...
        initElementMap: function () {
            ...
            for (var j = 0, len2 = el.length; j < len2; j++) {
                //查找有lazy_src标签的img
                console.log("lazy_src", typeof (el[j].getAttribute("lazy_src")))
                console.log("lazy-src", typeof (el[j].getAttribute("lazy-src")))
                if (typeof (el[j].getAttribute("lazy_src"))) {
                    ele_obj.push(el[j]);
                    download_count++;
                }
            }
            console.log("download_count: ", download_count);
        },
        //防止多次加载
        lazy: function () {
            ...
            for (var i = 0, len = ele_obj.length; i < len; i++) {
                ...
                console.log("t-index: ", t_index);
                console.log("t-innerHeight: ", innerHeight);
